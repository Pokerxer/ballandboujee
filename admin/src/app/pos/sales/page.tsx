...
function OrderDetail({
    ...
    const html = `
      ...
      <body>
        ...
        <div class="footer">
          ...
          <div style="margin-top: 4px;">Thank you for shopping at Ball & Boujee!</div>
        </div>
      </body>
      </html>
    `;
  ...
  function printInvoice() {
    ...
    w.document.write(`<html><head><title>Invoice ${sale.receiptNumber}</title><style>
      ...
      <div class="footer"><p>Thank you for shopping at Ball & Boujee!</p></div>
    </body></html>`);
    w.document.close();
    w.print();
  }
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div ref={printRef} style={{ display: 'none' }}>
        ...
        <p className="center">Thank you for shopping at Ball & Boujee!</p>
      </div>
